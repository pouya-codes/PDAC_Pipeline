...
@LogWarnErr(l)
@LogInfo(l)
def task_0(pipeline_name='__shared__only___01_Extract_Pathes'):
    ...
    print 'running __shared__only___01_Extract_Pathes pipeline with command: %s' % (cmd)
    ...
    try:
        ...
        print '__shared__only___01_Extract_Pathes pipeline finished with exit code %s' % (proc.returncode)
