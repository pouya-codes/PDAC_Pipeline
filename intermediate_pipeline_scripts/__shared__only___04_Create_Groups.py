...
TASK_CREATE_GROUPS_task.update_comp_args(__pipeline__config_file_location='/projects/ovcare/classification/pouya/components/PDAC_Binary_Pipeline/04_Create_Groups.json', __pipeline__slurm_max_time='10:00:00', __pipeline__slurm_error='/home/poahmadvand/ml/slurm/create_groups.%j.err', __pipeline__slurm_machine='dlhost02', __pipeline__slurm_job_name='create_groups', __pipeline__slurm_num_cpu=2, __pipeline__slurm_output='/home/poahmadvand/ml/slurm/create_groups.%j.out', __pipeline__singularity_image='/projects/ovcare/classification/pouya/components/docker_create_groups_old/docker_create_groups.sif', __pipeline__parameters=None, __pipeline__slurm_queue='dgxV100', __pipeline__output_files=None, )
...
#--------------------------------------------------------------------------------
@ruffus.follows(*[])
@ruffus.parallel(TASK_CREATE_GROUPS_component.component_name, 'TASK_CREATE_GROUPS', [])
