...
TASK_A_task.update_comp_args(__pipeline__config_file_location='/projects/ovcare/classification/pouya/components/PDAC_Binary_Pipeline/01_Extract_Pathes.json', __pipeline__slurm_max_time='200:00:00', __pipeline__slurm_error='/projects/ovcare/classification/pouya/logs/local_ec_100_extract.%j.err', __pipeline__slurm_machine='dlhost02', __pipeline__slurm_job_name='PDAC_annotation_extraction_slurm', __pipeline__slurm_num_cpu=30, __pipeline__slurm_num_gpu=1, __pipeline__slurm_output='/projects/ovcare/classification/pouya/logs/local_ec_100_extract.%j.out', __pipeline__slurm_memory='100G', __pipeline__singularity_image='/projects/ovcare/classification/pouya/components/docker_patch_annotation_extraction/docker_patch_annotation_extraction_latest.sif', __pipeline__parameters=None, __pipeline__slurm_queue='dgxV100', __pipeline__output_files=None, )
