...
@LogWarnErr(l)
@LogInfo(l)
def task_0(pipeline_name='__shared__only___05_Create_Train_Files'):
    ...
    print 'running __shared__only___05_Create_Train_Files pipeline with command: %s' % (cmd)
    ...
    try:
        ...
        print '__shared__only___05_Create_Train_Files pipeline finished with exit code %s' % (proc.returncode)
