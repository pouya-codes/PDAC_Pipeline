...
@LogWarnErr(l)
@LogInfo(l)
def task_0(pipeline_name='__shared__only___02_Preprocess'):
    ...
    print 'running __shared__only___02_Preprocess pipeline with command: %s' % (cmd)
    ...
    try:
        ...
        print '__shared__only___02_Preprocess pipeline finished with exit code %s' % (proc.returncode)
